...
"[project]/apps/cms/src/actions/data:b06176 [app-ssr] (ecmascript) <text/javascript>", ((__turbopack_context__) => {
"use strict";
...
;
 //# sourceMappingURL=data:application/json;base64,
}),
...
var __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$cms$2f$src$2f$actions$2f$data$3a$b06176__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$text$2f$javascript$3e$__ = __turbopack_context__.i("[project]/apps/cms/src/actions/data:b06176 [app-ssr] (ecmascript) <text/javascript>");
var __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$cms$2f$src$2f$actions$2f$data$3a$e1324a__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$text$2f$javascript$3e$__ = __turbopack_context__.i("[project]/apps/cms/src/actions/data:e1324a [app-ssr] (ecmascript) <text/javascript>");
'use client';
;
;
;
...
function UserActions({ user }) {
    ...
    const handleRoleChange = (newRole)=>{
        startTransition(async ()=>{
            const result = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$cms$2f$src$2f$actions$2f$data$3a$b06176__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$text$2f$javascript$3e$__["updateUserRole"])(user.id, newRole);
            if (result?.error) {
    ...
    const handleStatusChange = ()=>{
        ...
        startTransition(async ()=>{
            const result = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$cms$2f$src$2f$actions$2f$data$3a$e1324a__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$text$2f$javascript$3e$__["updateUserStatus"])(user.id, newStatus);
            if (result?.error) {
                __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["toast"].error(result.error);
            } else {
...
//# sourceMappingURL=_63f8227c._.js.map