...
"[project]/apps/cms/src/actions/data:762698 [app-client] (ecmascript) <text/javascript>", ((__turbopack_context__) => {
"use strict";
...
"[project]/apps/cms/src/actions/data:b9b13d [app-client] (ecmascript) <text/javascript>", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$cms$2f$src$2f$actions$2f$data$3a$762698__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$text$2f$javascript$3e$__ = __turbopack_context__.i("[project]/apps/cms/src/actions/data:762698 [app-client] (ecmascript) <text/javascript>");
var __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$cms$2f$src$2f$actions$2f$data$3a$b9b13d__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$text$2f$javascript$3e$__ = __turbopack_context__.i("[project]/apps/cms/src/actions/data:b9b13d [app-client] (ecmascript) <text/javascript>");
;
...
function PublishActions({ id, isPublished }) {
    ...
    const handlePublish = ()=>{
        startTransition(async ()=>{
            const result = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$cms$2f$src$2f$actions$2f$data$3a$762698__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$text$2f$javascript$3e$__["publishContent"])(id);
            if (result?.error) {
    ...
    const handleUnpublish = ()=>{
        startTransition(async ()=>{
            const result = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$cms$2f$src$2f$actions$2f$data$3a$b9b13d__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$text$2f$javascript$3e$__["unpublishContent"])(id);
            if (result?.error) {
                __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"].error(result.error);
            } else {
...
//# sourceMappingURL=_fad15b6a._.js.map